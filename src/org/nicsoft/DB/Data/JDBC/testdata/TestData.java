package org.nicsoft.DB.Data.JDBC.testdata;
		...
		try {
			...
			Connection connection =
				JDBCDriver.getConnection(
					"./src/org/nicsoft/DB/Data/JDBC/drivers/ExcelJDBC.jar",
					"org.nicsoft.jdbc.ExcelDriver",
					"jdbc:excel://",
					"",
					""
				);
	...
	*/
	public static DataSet getMySqlDataSet(String connectionInfo, String userName, String passWord, String query, String dataSetName) {
		...
		try {
			...
			Connection connection =
					JDBCDriver.getConnection(
							"./src/org/nicsoft/DB/Data/JDBC/drivers/mysql-connector-java-5.1.35-bin.jar",
